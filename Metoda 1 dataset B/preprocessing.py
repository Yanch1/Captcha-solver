...
for root, dirs, files in os.walk(path):
    for name in tqdm(files, desc="Preprocessing images"):
        ...
        bg_color = int(find_background_color(image))
    
        #add padding
        image = cv2.copyMakeBorder(image, 8, 8, 8, 8, cv2.BORDER_CONSTANT, None, bg_color)
